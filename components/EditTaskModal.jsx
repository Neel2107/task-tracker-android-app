  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <TouchableOpacity className="mt-40" activeOpacity={1}>
            <View
              className="w-96  h-96"
              style={{
            ...
            >
              ...
              <Text className="text-center my-2  text-lg font-semibold">Edit Task</Text>
              <TextInput
            ...
            <View className="flex flex-row items-center space-x-2">
                ...
                <Dropdown
                    ...
                    inputSearchStyle={styles.inputSearchStyle}
                    iconStyle={styles.iconStyle}
                    data={Object.entries(statusMap).map(([key, { text }]) => ({ key, label: text }))}
                    maxHeight={300}
                    labelField="label"
                    valueField="key"
